-- school_create_actual_lesson_from_planned_rpc.sql
-- RPC: public.school_create_actual_lesson_from_planned
-- Purpose: Create one completed actual lesson linked to one planned lesson.
-- Status: EXECUTED ON SUPABASE. Rollback-tested, guard-tested, and commit-tested.
-- Version: v2.55.0-lesson-actual-from-planned-full-autopilot-20260607
--
-- Scope:
...
-- - actual status is fixed to completed.
-- - Student settlement month is inherited from planned.year_month.
-- - Teacher settlement month is derived from actual lesson date as YYYY-MM.
--
-- Not supported:
...
-- - Rollback test inserted a codex-test actual from a codex-test planned lesson
--   and left no residue.
...
--   actual lesson 52a4a8be-6575-4de0-a1a2-0c261055cbf2.
-- - Source planned lesson 85ab1365-7929-4818-a369-4a7c935c2368 kept status
--   planned. No wage lock detail, payment request, income, expense, account,
--   or account transaction was generated.
...
comment on function public.school_create_actual_lesson_from_planned(
  ...
  'Creates one completed actual school lesson linked to one planned lesson. Rejects duplicate linked actuals, locked student settlement months, and locked teacher wage months; does not modify planned records or generate settlement, wage, payment, income, expense, account, or account transaction rows.';
