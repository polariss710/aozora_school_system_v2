...
1. Personal business Cash System linkage school-side mapping/outbox checkpoint, 2026-06-13:
...
2. Personal business Cash System linkage Phase 1 planning, 2026-06-13:
   Completed the earlier read-only pre-implementation planning for `个人名义` teacher-wage JPY payment confirmation -> Cash System JPY transaction linkage. At that checkpoint, live read-only DB verification confirmed school had no cash/linkage/outbox tables yet, and Cash had no external-source/idempotency/school-reference fields or external JPY transaction RPC yet. The later 2026-06-13 checkpoints implemented Cash-side external JPY RPC support and school-side mapping/outbox support; payment confirmation integration remains separate.

3. Family account whitelist cleanup checkpoint, 2026-06-13:
...
4. Account/family account isolation first-stage checkpoint, 2026-06-13:
...
5. Expense exchange-rate optional checkpoint, 2026-06-13:
