...
- Personal business Cash System linkage Phase 1 is complete for `个人名义` teacher-wage JPY payment. Phase 2 is complete for personal-business `tuition` JPY income: school income -> income linkage event -> manual sync executor -> Cash System JPY income transaction -> school `synced` or `failed` status. These phases still do not cover 青空塾, CNY, reimbursements, company account spending, non-`teacher_wage` payments, non-`tuition` income, part-time wage income, automatic scheduling, or linked edit/reverse.
...
1. Personal business Cash System linkage Phase 2 Cash sync status UI, 2026-06-13:
   Added read-only Cash sync status display for personal-business tuition income without changing DB schema, SQL/RPC, or sync executor behavior. Income detail now shows a Cash sync card when `school_personal_cash_income_linkage_events` exists, including pending/synced/failed status, Cash transaction id, Cash account snapshot, `synced_at`, `last_error`, `retry_count`, and idempotency key. Income list now shows a compact Cash badge for linked tuition income: `Cash待同步`, `Cash已同步`, or `Cash失败`. Ordinary income edit/reverse guards remain unchanged. Failed retry operation UI, linked reverse sync, and automatic sync scheduling are still not implemented.

2. Personal business Cash System linkage Phase 2 completion, 2026-06-13:
...
3. Personal business Cash System linkage Phase 2 income detail guard checkpoint, 2026-06-13:
...
4. Personal business Cash System linkage Phase 2 income-entry UI checkpoint, 2026-06-13:
...
5. Personal business Cash System linkage Phase 2 sync-executor checkpoint, 2026-06-13:
...
6. Personal business Cash System linkage Phase 2 create-RPC checkpoint, 2026-06-13:
...
7. Personal business Cash System linkage Phase 2 school DB foundation checkpoint, 2026-06-13:
...
8. Personal business Cash System linkage Phase 1 completion and cleanup, 2026-06-13:
...
9. Personal business Cash System linkage payment-confirm outbox checkpoint, 2026-06-13:
...
10. Personal business Cash System linkage school-side mapping/outbox checkpoint, 2026-06-13:
...
11. Personal business Cash System linkage Phase 1 planning, 2026-06-13:
...
12. Family account whitelist cleanup checkpoint, 2026-06-13:
