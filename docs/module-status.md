...
- 只读/预览功能: monthly wage snapshot list, default non-void list filtering with explicit `已作废` review option, teacher/business/status filters, filter-preserving detail return links, wage detail snapshot, teacher duty report Excel export, payment request references.
