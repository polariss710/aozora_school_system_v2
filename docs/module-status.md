...
| 老师工资支付 | V1 可用 + historical personal Cash Phase 1 verified; Cash linkage v1 policy now requires all user-controlled-account wage payments to enter Cash | Align code guards with unified policy before real 2026-05 wage trial |
...
| 收入记录 | V1 可用 + historical personal tuition JPY Cash linkage verified; Cash linkage v1 policy now requires all tuition receipts through user-controlled accounts to enter Cash | Align income code with unified personal/青空塾, JPY/CNY policy |
