import { APP_VERSION } from "./config.js?v=expense-filter-explicit-query-20260808-1";
import { requireGlobalSession } from "./auth-guard.js?v=be-ui-20260806-1";
import { initExpensePage } from "./pages/expense-page.js?v=expense-filter-explicit-query-20260808-1";
