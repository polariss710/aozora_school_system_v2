...
assert.match(lessonHtml, /app\.css\?v=lesson-time-hint-removal-20260812-1/);
assert.match(lessonHtml, /lesson-app\.js\?v=lesson-time-hint-removal-20260812-1/);
assert.match(lessonApp, /lesson-page\.js\?v=lesson-time-hint-removal-20260812-1/);
