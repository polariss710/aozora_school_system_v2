...
assert.match(lessonHtml, /app\.css\?v=lesson-filter-layout-20260807-2/);
assert.match(lessonHtml, /lesson-app\.js\?v=lesson-filter-layout-20260807-2/);
assert.match(lessonApp, /lesson-page\.js\?v=lesson-filter-layout-20260807-2/);
