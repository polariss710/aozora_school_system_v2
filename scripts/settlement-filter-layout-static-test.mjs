...
const cssCacheKey = "student-settlement-tokyo-month-close-20260810-3";
const runtimeCacheKey = "student-settlement-tokyo-month-close-20260810-3";
...
assert.match(config, /APP_VERSION = "v10\.5\.37"/);
