...
assert.match(html, /settlement-app\.js\?v=student-settlement-tokyo-month-close-20260810-1/);
...
assert.match(app, /student-settlement-tokyo-month-close-20260810-1/g);
