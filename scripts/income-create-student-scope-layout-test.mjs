...
assert.match(html, /income-app\.js\?v=income-create-student-scope-layout-20260813-1/);
assert.match(app, /config\.js\?v=income-create-student-scope-layout-20260813-1/);
